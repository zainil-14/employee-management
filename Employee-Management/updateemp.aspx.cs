    ...
    public partial class updateemp : System.Web.UI.Page
    {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                con.Open();
                string query = "update emp set name='" + TextBox1.Text + "',email='" + TextBox2.Text + "', mno='" + TextBox3.Text + "',dob='" + TextBox4.Text + "',type='" + DropDownList1.SelectedValue.ToString() + "'where Id='"+DropDownList2.SelectedValue.ToString()+"'";
                SqlCommand cmd = new SqlCommand(query, con);
                cmd.ExecuteNonQuery();
                MsgBox(" Data Updated Successfully ", this.Page, this);
                con.Close();
            }
